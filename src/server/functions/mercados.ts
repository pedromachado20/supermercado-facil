...
export const criarMercado = createServerFn({ method: 'POST' }).handler(async ({ data }: { data: { name: string; websiteUrl?: string; address?: string; city?: string } }) => {
...
export const atualizarMercado = createServerFn({ method: 'POST' }).handler(async ({ data }: { data: { id: string; name: string; websiteUrl?: string; address?: string; city?: string } }) => {
...
export const excluirMercado = createServerFn({ method: 'POST' }).handler(async ({ data }: { data: { id: string } }) => {
